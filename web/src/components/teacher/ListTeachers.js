	...
	return (
		<div>
			...
			<Table
				...
				dataSource={data ? data.teachers.nodes : []} columns={columns}/>
			<Drawer
				...
				<Form
					...
					<Form.Item label={"Họ"} name={"lastName"} rules={[{required: true, message: "Họ là bắt buộc"}]}>
						<Input/>
					</Form.Item>
					<Form.Item label={"Tên"} name={"firstName"} rules={[{required: true, message: "Tên là bắt buộc"}]}>
						<Input/>
					</Form.Item>
					<Form.Item label={'Số điện thoại'} name={"phone"} rules={[{required: true, message: "Số điện thoại là bắt buộc"}]}>
						<Input/>
					</Form.Item>
					<Form.Item label={'Nơi công tác'} name={"workPlace"} rules={[{required: true, message: "Nơi công tác là bắt buộc"}]}>
						<Input/>
					</Form.Item>
					<div className={"submit"}>
						<Button loading={isLoading} htmlType={'submit'}>Thêm giảng viên</Button>
					</div>
				</Form>
			</Drawer>
			...
			<Drawer
				...
				<Form
					...
					<div className={"submit"}>
						<Button loading={isLoading} htmlType={'submit'}>Sửa thông tin giảng viên</Button>
					</div>
				</Form>
			</Drawer>
		</div>
