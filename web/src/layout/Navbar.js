...
import {Avatar, Button, Col, Dropdown, Form, Input, Menu, Modal, notification, Row} from "antd";
    ...
    return (
        <Container>
                ...
                <Col span={10} lg={6} style={{display: "flex", alignItems: "center", justifyContent: 'flex-end'}}>
                    {user && (
                        <div onClick={(e) => e.defaultPrevented} className="user-profile">
                            <span style={{marginRight: 10}}>{`${user.lastName} ${user.firstName}`}</span>
            ...
            <Modal
                ...
                onCancel={() => setVisible(false)} cancelText={"Huỷ"} okText={"Đồng ý"} visible={visible}
                title={"Đổi mật khẩu"}>
                ...
                }} id="changePasswordForm" layout={"vertical"}>
                        ...
                        rules={[
                            ...
                            ({getFieldValue}) => ({
                                validator(rule, value) {
                                    ...
                                    return Promise.reject('Mật khẩu và xác nhận mật khẩu không giống nhau');
                                },
                            }),
                        ]}
                    >
